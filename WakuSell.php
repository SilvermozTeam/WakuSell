...
use ModulesGarden\DomainsReseller\Registrar\WakuSell\Calls;
use ModulesGarden\DomainsReseller\Registrar\WakuSell\Core\Configuration;
use ModulesGarden\DomainsReseller\Registrar\WakuSell\Helpers\ResultsListFactory;

//Loader
include_once dirname(__FILE__) . DIRECTORY_SEPARATOR . 'Core' . DIRECTORY_SEPARATOR . "Loader.php";
new \ModulesGarden\DomainsReseller\Registrar\WakuSell\Core\Loader(__DIR__);
 ...
 * @return array $return
 */
function WakuSell_getConfigArray()
{
    $configarray = [
        "FriendlyName" => [
            "Type"  => "System",
        ...
        "Description"  => [
            "Type"  => "System",
            "Value" => "WakuSell is one of the fastest growing registrars in Africa and an Expert on Reseller"
        ],
        "Username"     => [
        ...
        "ApiEndpoint"  => [
            ...
            "Default"      => "https://my.wakusell.com/modules/addons/DomainsReseller/api/index.php"
        ],
    ];
 ...
 * @return array $return
 */
function WakuSell_RegisterDomain($params)
{
    $postfields =
        [
 ...
 * @return array $return
 */
function WakuSell_TransferDomain($params)
{
    $postfields =
        [
            "domain"       => $params["domainname"],
 ...
 * @return array $return
 */
function WakuSell_RenewDomain($params)
{
    $postfields =
        [
            "domain"    => $params["domainname"],
 ...
 * @return array $return
 */
function WakuSell_GetNameservers($params)
{
    $postfields =
        [
            "domain" => $params["domainname"]
 ...
 * @return array $return
 */
function WakuSell_SaveNameservers($params)
{
    $postfields =
        [
            "domain" => $params["domainname"],
 ...
 * @return array $return
 */
function WakuSell_ReleaseDomain($params)
{
    $postfields =
        [
            "domain"      => $params["domainname"],
 ...
 * @return array $return
 */
function WakuSell_GetEPPCode($params)
{
    $postfields =
        [
            "domain" => $params["domainname"],
 ...
 * @return array $return
 */
function WakuSell_GetContactDetails($params)
{
    $postfields =
        [
            "domain" => $params["domainname"],
 ...
 * @return array $return
 */
function WakuSell_SaveContactDetails($params)
{
    $postfields =
        [
            "domain"         => $params["domainname"],
 ...
 * @return array $return
 */
function WakuSell_GetRegistrarLock($params)
{
    $postfields =
        [
            "domain" => $params["domainname"],
 ...
 * @return array $return
 */
function WakuSell_SaveRegistrarLock($params)
{
    $postfields =
        [
            "domain"     => $params["domainname"],
 ...
 * @return array $return
 */
function WakuSell_GetDNS($params)
{
    $postfields =
        [
            "domain" => $params["domainname"],
 ...
 * @return array $return
 */
function WakuSell_SaveDNS($params)
{
    $postfields =
        [
            "domain"     => $params["domainname"],
 ...
 * @return array $return
 */
function WakuSell_RegisterNameserver($params)
{
    $postfields =
        [
            "domain" => $params["domainname"],
 ...
 * @return array $return
 */
function WakuSell_ModifyNameserver($params)
{
    $postfields =
        [
            "domain" => $params["domainname"],
 ...
 * @return array $return
 */
function WakuSell_DeleteNameserver($params)
{
    $postfields =
        [
            "domain"     => $params["domainname"],
 ...
 * @return array $return
 */
function WakuSell_RequestDelete($params)
{
    $postfields =
        [
            "domain" => $params["domainname"]
 ...
 * @return array $return
 */
function WakuSell_TransferSync($params)
{
    $postfields =
        [
 ...
 * @return array $return
 */
function WakuSell_GetEmailForwarding($params)
{
    $postfields =
        [
            "domain" => $params["domainname"]
 ...
 * @return array $return
 */
function WakuSell_SaveEmailForwarding($params)
{
    $postfields =
        [
            "domain"    => $params["domainname"],
 ...
 * @return array $return
 */
function WakuSell_IDProtectionToggle($params)
{
    $postfields =
        [
            "domain" => $params["domainname"],
 ...
 * @return array
 */
function WakuSell_IDProtectToggle($params)
{
    return WakuSell_IDProtectionToggle($params);
}
 ...
 */
function WakuSell_CheckAvailability($params)
{
    $postfields =
        [
